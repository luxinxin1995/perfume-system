<template>
    <div class="container">
        <el-table :data="tableData5" style="width: 100%">
            ...
            <el-table-column label="商店名称" prop="name">
            </el-table-column>
            <el-table-column label="商店地址" prop="address">
            </el-table-column>
            <el-table-column label="商店介绍" prop="desc">
            </el-table-column>
            <el-table-column fixed="right" label="操作" width="300">
                <template slot-scope="scope">
                    <el-button type="default" size="mini" @click="dialogFormVisible = true">编辑</el-button>
                    <el-button type="default" size="mini">添加商品</el-button>
                    <el-button type="danger" size="mini">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!--对话框-->
        <el-dialog title="修改商店信息" :visible.sync="dialogFormVisible">
