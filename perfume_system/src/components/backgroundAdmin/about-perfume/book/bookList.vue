    ...
    <div class="fillcontain">
        <div class="table_container">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>香水书籍管理</el-breadcrumb-item>
                <el-breadcrumb-item>香水书籍列表</el-breadcrumb-item>
            </el-breadcrumb>
            <div class="add">
                <el-button size="mini" type="primary" @click="addBook()" icon="el-icon-plus">新增</el-button>
            </div>
...
import projcetAddOrEdit from './addBook'
export default {
    components: {
        projcetAddOrEdit
    },
    ...
    methods: {
        ...
        handleEdit(index, row) {
            ...
            this.formObj = obj
            this.projcetAddOrEditShow = true
            this.titleText = '编辑关于香水的书籍'
        },
        // 删除书籍
        handleDelete(index, row) {
            var id = row._id
            axios.postbookDelete(id, res => {
                if (res.code == 'success') {
